...
class PropertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create propert" do
    assert_difference("Propert.count") do
      post properts_url, params: { propert: { address: @propert.address, bathrooms: @propert.bathrooms, name: @propert.name, price: @propert.price, rooms: @propert.rooms } }
    end
  ...
  test "should update propert" do
    patch propert_url(@propert), params: { propert: { address: @propert.address, bathrooms: @propert.bathrooms, name: @propert.name, price: @propert.price, rooms: @propert.rooms } }
